...
Medium::Medium(string name, Size size, int health,
	       int speed):Warhorse(name, size, health, speed){
  
}

//Attack for Medium warhorse
int Medium::attack(string target, int health){
  cout << "The medium warhorse " << getName() << " hits " << target << endl;
